      ...
      >
        ...
        <div className="relative inset-0 pointer-events-none">
          ...
          <motion.div style={{ y: card2Y, scale, x: "-20%" }} className="absolute top-1/3 left-[10%] w-[280px]">
            <div className="bg-[#C4A052]/10 backdrop-blur-lg rounded-xl p-6 border border-[#C4A052]/80">
              <img
          ...
          <motion.div style={{ y: card3Y, scale, x: "30%" }} className="absolute top-1/2 right-[10%] w-[320px]">
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-[#C4A052]/80">
